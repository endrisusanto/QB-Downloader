...
import type { BuildArtifactGroup, DownloadEvent, SectionKey } from "../types";
...
export function TaskAccordions(props: Props) {
  ...
  return (
    <div className="accordion-stack">
      <div className="accordion-controls"><button className="icon-button" title="Expand all" onClick={() => props.onExpandAll(true)}><ChevronsUpDown size={17} /></button><button className="icon-button" title="Collapse all" onClick={() => props.onExpandAll(false)}><ChevronsDownUp size={17} /></button></div>
